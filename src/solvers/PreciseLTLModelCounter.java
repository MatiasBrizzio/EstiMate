...
public class PreciseLTLModelCounter {
    ...
    public final String PROP_FILE = BASENAME + "-k" + Settings.MC_BOUND + ".sat";
    public final String PROP_CNF_FILE = BASENAME + "-k" + Settings.MC_BOUND + ".cnf";
    ...
    public String getCommand() {
        ...
        String currentOS = System.getProperty("os.name");
        if (currentOS.startsWith("Mac"))
            cmd = "./lib/ltl-model-counter/ltl-modelcountermac.sh " + INFILE + " " + BASENAME + " " + Settings.MC_BOUND + " " + modelcounter.toString();
        else
            cmd = "./lib/ltl-model-counter/ltl-modelcounterlinux.sh " + INFILE + " " + BASENAME + " " + Settings.MC_BOUND + " " + modelcounter.toString();
        return cmd;
    }
